...
def main():
    ...
    with open("config.yaml", "w") as out:
        ...
        if args.url is None and args.accession is None:
            ...
            out.write("input_dir" + " : " + args.input_dir.strip("/") + "\n")
...
#python config.py -g /lustre/scratch117/cellgen/team218/gp7/Genome/mm10/mm10.fa -gab /lustre/scratch117/cellgen/team218/gp7/Genome/mm10/Tracks/Gene_annotation/gencode.vM11.annotation.bed12 -gaf /lustre/scratch117/cellgen/team218/gp7/Genome/mm10/Tracks/Gene_annotation/gencode.vM11.transcripts.fa -U2_5 /lustre/scratch117/cellgen/team218/gp7/Genome/mm10/Tracks/SpliceRack/mm10_GT_AG_U2_5.good.matrix -U2_3 /lustre/scratch117/cellgen/team218/gp7/Genome/mm10/Tracks/SpliceRack/mm10_GT_AG_U2_3.good.matrix -p /lustre/scratch117/cellgen/team218/gp7/Genome/mm10/Tracks/Phylop/mm10.60way.phyloP60way.bw -u url/URL_list/TOTAL.url.txt -s url/URL_list/split.txt
